...
export function RefundDetailPage() {
  ...
  const handleCompleteRefund = async () => {
    if (!id || !window.confirm("Xác nhận hoàn tiền cho yêu cầu này?")) {
      return;
    }
  ...
  const handleCancelRefund = async () => {
    if (!id || !window.confirm("Từ chối yêu cầu hoàn tiền này?")) {
      return;
    }
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="font-medium">
                  {formatCurrency(refund.principal)}
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-2">
                ...
                {refund.damageAmount > 0 && (
                  <div className="flex justify-between items-center px-3 py-2 bg-red-50 rounded">
                    ...
                    <span className="text-red-600 font-medium">
                      -{formatCurrency(refund.damageAmount)}
                    </span>
                  </div>
                )}
                ...
                {refund.overtimeAmount > 0 && (
                  <div className="flex justify-between items-center px-3 py-2 bg-red-50 rounded">
                    ...
                    <span className="text-red-600 font-medium">
                      -{formatCurrency(refund.overtimeAmount)}
                    </span>
                  </div>
                )}
